import sys
import json
sys.path.append("C:/wojtek746/NeuralNetworks/net_38_115")
import net_38_115 as NN_38_115
sys.path.append("C:/wojtek746/NeuralNetworks/net_38_20")
import net_38_20 as NN_38_20
sys.path.append("C:/wojtek746/NeuralNetworks/net_40_7")
import net_40_7 as NN_40_7
sys.path.append("C:/wojtek746/NeuralNetworks/net_38_2")
...
if name == "pushing" or name == "grenade":
    inputs = [0] * 39
    for i in range(38):
        inputs[i] = int(sys.argv[i + 1])
    ...
    with open("C:/wojtek746/borgo/hegemonia.json", "r") as file:
        ...
        if name == "grenade":
            ...
            g = False
        nn = NN_40_7.Net(inputs, hq["weights1"], hq["biases1"], hq["weights2"], hq["biases2"], p, g)
        print(nn.feed_forward())
else:
    if name != "battle" and name != "hq" and name != "move":
        with open("C:/wojtek746/borgo/hegemonia.json", "r") as file:
            hq = json.loads(file.read())[name]
        ...
        with open("C:/wojtek746/borgo/hegemonia.json", "r") as file:
            ...
            if name == "move":
                ...
                m = False
            nn = NN_38_20.Net(inputs, hq["weights1"], hq["biases1"], hq["weights2"], hq["biases2"], hq["weights3"], hq["biases3"], hq["weights4"], hq["biases4"], h, m, False)
            print(nn.feed_forward())
    else:
        with open("C:/wojtek746/borgo/hegemonia.json", "r") as file:
